...
db.define_table('users',
                ...
                Field('full_name','string',length=200,requires=[IS_NOT_EMPTY(),IS_LENGTH(50,error_message='enter maximum 50 character')]),
                Field('email','string',unique=True,length=100,requires=IS_NOT_EMPTY()),
                Field('mobile','string',length=20,requires=[IS_NOT_EMPTY(),IS_LENGTH(11,error_message='enter maximum 11 character')]),
                Field('password','string',length=256,default='-'),
                Field('gender','string',length=10,requires=IS_NOT_EMPTY()),
                Field('location','string',length=100),
                Field('user_type','string',length=20,default="permanent"),
